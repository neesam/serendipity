            ...
            if (table.includes("album") || table.includes("artist")) {
                try {
                    const response = await fetch(
                        `https://first-choice-porpoise.ngrok-free.app/api/add_to_music_table/${table}/${title}`,
                        {
                            method: "POST",
                ...
                try {
                    const response = await fetch(
                        `https://first-choice-porpoise.ngrok-free.app/api/add_to_film_table/${table}/${title}`,
                        {
                            method: "POST",
                            headers: { "Content-type": "application/json" },
                        },
                ...
                try {
                    const response = await fetch(
                        `https://first-choice-porpoise.ngrok-free.app/api/add_to_show_table/${table}/${title}`,
                        {
                            method: "POST",
                            headers: { "Content-type": "application/json" },
                        },
                ...
                try {
                    const response = await fetch(
                        `https://first-choice-porpoise.ngrok-free.app/api/add_to_book_table/${title}`,
                        {
                            method: "POST",
                            headers: { "Content-type": "application/json" },
                        },
