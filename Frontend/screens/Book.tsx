...
const Book = () => {
    ...
    const getBook = async () => {
        ...
        try {
            ...
            if (bookAnthologies.includes(data["data"][0]["title"])) {
                ...
                setBook(data["data"][0]["title"] + " " + getRandomInt(2, 5));
            } else {
                setBookID(data["data"][0]["id"]);
    ...
    const deleteBook = async () => {
        ...
        try {
            const response = await fetch(
                `${API_BASE_URL}/api/books/${bookID}/from/${whichTable}/${EXPO_PUBLIC_BOOK_TABLES_DATASET}`,
                {
                    method: "DELETE",
